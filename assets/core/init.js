...
(function () {
  ...
  var TYPES = {
    ...
    fleuriste:    { label:'Fleuriste',     emoji:'💐', palette:{ primary:'#4A6741', primary_dark:'#2F4A28', accent:'#E89BAE', accent_light:'#F4C4D2', danger:'#C84B4B', cream:'#FAF5F2', cream_dark:'#EFE3DC' }, fonts:{ display:'"Playfair Display"', body:'"Plus Jakarta Sans"' }, features:{ saison:true, bio:true,  provenance:true,  decoupe:false, cuisson:false, programmation:true,  dlc:true  }, labels:{ produits:'Notre boutique',   arrivage:'Arrivage du jour',  coups_coeur:'Coups de cœur du fleuriste', panier:'Mon bouquet' } },
