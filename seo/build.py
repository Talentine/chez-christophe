...
def build_llms(arts: list[dict], metiers: list[dict]) -> None:
    lignes = [f"# {BRAND}", "",
              ...
              "frais d'installation uniques de 249 à 549 €. Empreinte bancaire anti no-show optionnelle (75 % du panier, libérée 24 h après le retrait). Marchéo ne livre pas et n'a pas de coursiers : il fournit l'outil (zone, créneaux, minimum de commande, frais, tournée) pour que le commerçant organise sa propre livraison. "
